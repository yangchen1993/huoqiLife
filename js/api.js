 ...
 */
// window.HOST = "http://192.168.1.109:8081/";
...
window.API = {
    "BUSINESS":{
        ...
        "GET_ACCOUNT_INFO":[window.HOST,'business/income'].join("")        //获取账户信息
    ...
    "BUYER":{
        ...
        "ABOUT_US":[window.HOST,'memb/article'].join(""),      //关于我们

        "GET_CAROUSELS":[window.HOST,'memb/carousel'].join("")       //获取轮播图
    }
};
